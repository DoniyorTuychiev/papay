    ...
    async signupData(input) {
        ...
        try{
            ...
            let result;                                                 //result ga try ni ichidayam tashqarisidayam ulana olish uchun let result ni tashqarida  yaratdik
                                                                       //bu orinda MongoDB dan kelishi mumkin bolgan EROR lar uchun alohida try/catch ochib unga err ni 
            try{                                                       //mistake.js da Definer class ochdik va err ga qiymat berdik
