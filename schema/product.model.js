...
const productSchema = new mongoose.Schema({
    ...
    product_size: {
        type: String,
        default: "normal",
        required: function() { //bu yerda function tuzvolamiz yani ichimlik emas ovqat bolganda product_size ni  chaqir yani normal,set,large kabi
    ...
    product_volume: {
        type: String,
        default: 1 ,
        required: function() { //bu yerda function tuzvolamiz yani ovqat emas ichimlik bolganda volumeni chaqir yani 1 Liter,2 liter kabi
